...
## Construction
{% include images/figure.html class="img-right" width="100%" caption="Looking west on the construction of the original Student Union Building, 1936. Source: Center for Southwest Research" image-path="images/anth-construction.jpg" %}
...
{% include images/figure.html class="img-right" width="48%" caption="Even after completion, the SUB stood amongst barren terrain. [Source](https://econtent.unm.edu/digital/collection/ULPhotoImag/id/75)" image-path="images/anth-exterior.jpg" %}
...
## Anthropology, Today
{% include images/figure.html class="img-left" width="48%" caption="Unlike its early years as the Student Union Building, the east entrance of the Anthropology building is now obscured by trees. Photo by Maxine Porter, 2019." image-path="images/anth-modern.jpg" %}

{% include images/figure.html class="img-right" width="48%" caption="Entrance to the Maxwell Museum of Anthropology, south side of the Anthropology building. Photo by Maxine Porter, 2019." image-path="images/maxwell-new.jpg" %}
