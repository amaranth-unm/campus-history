...
## Construction
{% include images/figure.html class="img-center" width="100%" caption="Looking west on the construction of the original Student Union Building, 1936. Source: Center for Southwest Research" image-path="images/anth-construction.jpg" %}
...
{% include images/figure.html class="img-center" width="100%" caption="Even after completion, the SUB stood amongst barren terrain. [Source](https://econtent.unm.edu/digital/collection/ULPhotoImag/id/75)" image-path="images/anth-exterior.jpg" %}
...
{% assign anth_records_images =
"images/anth-faculty-correspondence.jpg,
images/anth-plans.jpg" | split: ','
%}

{% assign anth_records_captions =
...
Contemporary layout of Anthropology building. Source: Center for Southwest Research" | split: '|'
%}

{% include images/image-grid.html
images=anth_records_images
captions=anth_records_captions
columns=2
%}

## Anthropology, Today
{% assign anth_today_images =
"images/anth-modern.jpg,
images/maxwell-new.jpg" | split: ','
%}

{% assign anth_today_captions =
...
Entrance to the Maxwell Museum of Anthropology, south side of the Anthropology building. Photo by Maxine Porter, 2019." | split: '|'
%}

{% include images/image-grid.html
images=anth_today_images
captions=anth_today_captions
columns=2
%}
