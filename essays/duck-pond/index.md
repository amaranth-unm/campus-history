...
{% include images/figure.html class="img-left" width="48%" caption="A letter of complaint against the pond sent to the Campus planning committee from Tom Zepper, Assistant Dean." image-path="images/duck-pond-0004.png" %}

{% include images/figure.html class="img-right" width="48%" caption="An article from the Daily Lobo published October 8, 1975 referring to the Duck Pond as the Concrete Pond." image-path="images/duck-pond-0003.png" %}
