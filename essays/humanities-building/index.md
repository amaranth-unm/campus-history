...
They go on to craft a vision, both collaboratively and individually within departments, of a building that would reflect this eloquent and humanistic vision. Among their group requests were:
...
- "rooms with paintings and sculpture and design in which persons will respond with feeling and thought"
...
> "All rooms must have windows for it is no accident that the metaphor of light, sunlight, has played a dominant role in the humanistic tradition as a symbol of wisdom, knowledge and vision. And where there is sunlight there is organic growth, so let's have indoor planting, perhaps around a fountain and pool, perhaps a lounge on the roof that is a solarium, a roof terrace, a grove of academia."
...
image-path="images/humanities-building-architectural-drawing.jpg"
%}
...
> "A massive cement blockhouse with tiny windows and partly concealed entrances may be suitable for a fall-out shelter or defense center in the event of enemy invasion, but is not in keeping with the function and spirit of the humanities departments the new building is to house."
...
image-path="images/humanities-building-muddy-hole.jpg"
%}
...
image-path="images/humanities-building-construction-van.jpg"
%}
...
image-path="images/humanities-building-construction-full.jpg"
%}
...
image-path="images/humanities-building-old-plaza.jpg"
%}
...
image-path="images/humanities-building-from-above.jpg"
%}
...
Because of this, the Humanities building occupies an important space, not only geographically on campus, but also intellectually and experientially for the vast majority of the student population.
