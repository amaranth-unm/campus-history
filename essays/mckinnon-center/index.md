...
{% include images/figure.html class="img-center" width="100%" caption="The demolition of the West ASM building. The East ASM building was not included in the demolition but was definitely affected. [_Source_](https://www.mgt.unm.edu/building/construction-photos.asp)" image-path="images/mcm-construction-1.jpg" %}

{% include images/figure.html class="img-center" width="100%" caption="Removal of interior materials to be separated and recycled. [_Source_](https://www.mgt.unm.edu/building/construction-photos.asp)" image-path="images/mcm-construction-4.jpg" %}

{% include images/figure.html class="img-center" width="100%" caption="Early morning construction while campus is empty. Crews worked long days to finish the construction in a timely manner in order to limit campus inaccessbibility as much as possible. [_Source_](https://www.mgt.unm.edu/building/construction-photos.asp)" image-path="images/mcm-construction-2.jpg" %}
...
{% include images/figure.html class="img-center" width="100%" caption="Skeletal structure of MCM. The large construction zone created hazards and difficulties for students and staff who had classes in the surrounding buildings. [_Source_](https://www.mgt.unm.edu/building/construction-photos.asp)" image-path="images/mcm-construction-5.jpg" %}
