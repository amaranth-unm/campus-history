...
{% include images/figure.html class="img-right" width="33%" caption="Betty's bronze scultures with a green hat placed on one of the heads" image-path="images/modern-art-intro.png" %}
...
{% include images/figure.html class="img-right" width="33%" caption="The tower, built by Gary Beales, at the center of 'Modern Art'" image-path="images/modern-art-tower.png" %}
...
{% include images/figure.html class="img-right" width="33%" caption="Just ahead in the horizon of UNM's 'Free Speech Zone' lie Betty Sabo's artwork" image-path="images/modern-art-free-speech.png" %}
...
{% include images/figure.html class="img-right" width="33%" caption="The bronze status defaces" image-path="images/modern-art-vandalism.png" %}
...
{% include images/figure.html class="img-right" width="33%" caption="The rock sculture in place before erection of Modern Art" image-path="images/modern-art-tbt.png" %}

{% include images/figure.html class="img-right" width="33%" caption="Planning of the original art" image-path="images/modern-art-tbt-plan.png" %}
...
{% include images/figure.html class="img-right" width="33%" caption="Betty Sabo pictured with her creation shortly before her death (1928 - 2016)" image-path="images/modern-art-betty-dead.png" %}
