...
{% include images/figure.html class="right" width="50%" caption="An early illustration of Popejoy Hall" image-path="images/popejoy-diagram.png" %}
...
{% include images/figure.html class="right" width="50%" caption="Albuqurque Journal article published in the weeks leading up to the opening." image-path="images/popejoy-article.png" %}
